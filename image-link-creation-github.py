...
file_path = "https://raw.githubusercontent.com/Nikhil-Lakha/HouseFlipping/main/Sold-Properties/All-Sold-Properties.csv"
sold_properties = pd.read_csv(file_path)

# Define the directory path for sold house images
directory_path = 'https://github.com/Nikhil-Lakha/HouseFlipping/tree/main/Sold-House-Images'
